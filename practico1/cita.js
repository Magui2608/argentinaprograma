...
/*4.a. Recuperes la longitud de la cita y la guardes en una variable llamada
tamañoDeCita. Deberás imprimir por consola un mensaje con el
siguiente formato: “El tamaño de la cita es: [tamañoCita]”*/
let tamañoDeCita = cita.length;
console.log("El tamaño de la cita es: ", tamañoDeCita);

/*4.b. Busques la posición del índice donde aparece substring en cita, y
